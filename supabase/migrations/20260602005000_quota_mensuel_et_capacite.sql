-- ===========================================================================
-- D1 : creer_demande_rdv — vérification quota mensuel par véhicule
-- D2 : assigner_rdv — capacité 3→2 + contrat_ligne_id sur interventions
-- ===========================================================================

-- ============================================================
-- D1 — creer_demande_rdv avec vérification quota mensuel
-- ============================================================
...
-- ============================================================
-- D2 — assigner_rdv : capacité 3→2 + contrat_ligne_id
-- ============================================================
...
BEGIN
  ...
  FOREACH v_vehicule_id IN ARRAY v_demande.vehicule_ids LOOP
    ...
    -- Recherche du contrat_ligne_id correspondant (pour le décompte v_contrats_passages_restants)
